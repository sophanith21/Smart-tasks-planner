...
export default function Nav() {
  ...
  return (
    <>
      <div className='h-[84vh] flex flex-col gap-8 p-8  items-center justify-center bg-gradient-to-br from-white-50 to-black-100'>
        <div className='bg-[#EDEDED] p-8 rounded-2xl w-[78vw] min-w-173 h-[66.6%] overflow-hidden flex flex-col items-center justify-between'>
          <h2
        ...
        <div className='bg-transparent gap-8 rounded-lg w-[78vw] min-w-173 h-[33.3%] flex items-center justify-center'>
          <div
            className='bg-[#EDEDED] p-8 rounded-2xl w-1/2 h-full flex items-center justify-between hover:cursor-pointer hover:shadow-lg hover:shadow-gray-300 transition-transform duration-200 hover:scale-102'

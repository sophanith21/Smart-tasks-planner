        ...
        <section className='w-full px-6 py-20 md:py-18 text-center bg-black text-white flex flex-col md:flex-row justify-center items-center gap-4'>
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            <p className='text-lg md:text-xl text-gray-400 mb-10 md:text-left'>
              Our AI-powered planner offers suggestions to optimize your tasks.
              You can schedules your day, keep track and manage your time.
              Reclaim your time and achieve your goals faster.
            </p>
            {isAuthenticated() ? (
          ...
          <div className='mx-auto px-6'>
            <div className='text-center mb-16 flex flex-col items-center'>
              ...
              <p className='text-gray-600 mt-4 max-w-2xl mx-auto'>
                ...
                <br />
                Smart Tasks Planner helps you organize, prioritize, and schedule
                your tasks with ease. Let our AI assist you in planning your day
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-12'>
              <div className='text-center'>
                <div className='flex items-center justify-center h-16 w-16 bg-indigo-100 rounded-full mx-auto mb-4'>
                  <img src={task} alt='Setting Tasks' className='h-[2.5rem]' />
                </div>
                <h4 className='text-xl font-bold text-gray-900 mb-2'>
                  Setting Tasks
                </h4>
                <p className='text-gray-600'>
                  Easily set and manage your tasks with our intuitive interface.
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>
                  Prioritize your tasks effectively. Our planner helps you focus
                  on what matters most by allowing you to set task priorities.
                </p>
              </div>
              <div className='text-center'>
                <div className='flex items-center justify-center h-16 w-16 bg-indigo-100 rounded-full mx-auto mb-4'>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>
                  View your entire schedule at a glance. Our planner provides a
                  clear overview of your tasks and deadlines, helping you stay
                  organized.
                </p>
              </div>
              <div className='text-center'>
